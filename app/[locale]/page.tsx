    ...
    <div className="flex min-h-screen flex-col overflow-x-hidden">
      ...
      <main className="flex-1">
        ...
        <section className="relative py-24 md:py-32 overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-hero -z-10 opacity-20" />
          <div className="absolute inset-0 bg-[url('/images/hero-photo-support.png')] bg-cover bg-center -z-10 opacity-30 mix-blend-soft-light" />
